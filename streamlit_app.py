...
if showDetails:
    ...
    st.metric("👨‍💻 > 🕵️‍♀️ Bob hat mehr Informationen als Eve", "✅" if condition1 else "❌")
    st.metric("Schlüsselaustausch auch möglich wenn Eves Information unbekannt", "✅" if condition2 else "❌")
